...
class ProductService
{
    ...
    {
        $validator = Validator::make($request->all(), (new StoreProductRequest)->rules(), (new StoreProductRequest)->messages());
        if ($validator->fails()) {
    ...
    {
        $validator = Validator::make($request->all(), (new UpdateProductRequest)->rules($id));
